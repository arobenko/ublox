...
public:
    MgaBdsIono();
    MgaBdsIono(const MgaBdsIono&) = delete;
    MgaBdsIono(MgaBdsIono&&) = delete;
    virtual ~MgaBdsIono();

    MgaBdsIono& operator=(const MgaBdsIono&);
...
extern template class ublox::message::MgaBdsIono<ublox::cc_plugin::Message>;
