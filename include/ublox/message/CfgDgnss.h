...
class CfgDgnss : public
    comms::MessageBase<
        ...
        comms::option::FieldsImpl<CfgDgnssFields::All<TDataOpt> >,
        comms::option::MsgType<CfgDgnss<TMsgBase, TDataOpt> >
    >
{
public:
    ...
    ///
    ///     The field names are:
    ///     @li @b version for @ref CfgDgnssFields::version field
    ///     @li @b numOsc for @ref CfgDgnssFields::numOsc field
    ///     @li @b reserved1 for @ref CfgDgnssFields::reserved1 field
    ///     @li @b data for @ref CfgDgnssFields::data field
