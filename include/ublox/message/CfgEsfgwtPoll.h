...
/// @file
/// @brief Contains definition of CFG-ESFGWT (@b poll) message and its fields.
...
/// @brief Accumulates details of all the CFG-ESFGWT (@b poll) message fields.
/// @see CfgEsfgwtPoll
struct CfgEsfgwtPollFields
{
    /// @brief All the fields bundled in std::tuple.
    using All = std::tuple<>;
};

/// @brief Definition of CFG-ESFGWT (@b poll) message
/// @details Inherits from @b comms::MessageBase
///     while providing @b TMsgBase as common interface class as well as
///     various implementation options. @n
///     See @ref CfgEsfgwtPollFields and for definition of the fields this message contains.
