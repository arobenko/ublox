...
/// @file
/// @brief Contains definition of CFG-NAV5 (@b poll) message and its fields.
...
/// @brief Accumulates details of all the CFG-NAV5 (@b poll) message fields.
/// @see CfgNav5Poll
...
/// @brief Definition of CFG-NAV5 (@b poll) message
/// @details Inherits from @b comms::MessageBase
///     while providing @b TMsgBase as common interface class as well as
///     various implementation options. @n
///     See @ref CfgNav5PollFields and for definition of the fields this message contains.
