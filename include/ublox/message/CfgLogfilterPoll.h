...
/// @file
/// @brief Contains definition of CFG-LOGFILTER (@b poll) message and its fields.
...
/// @brief Accumulates details of all the CFG-LOGFILTER (@b poll) message fields.
/// @see CfgLogfilterPoll
...
/// @brief Definition of CFG-LOGFILTER (@b poll) message
/// @details Inherits from @b comms::MessageBase
///     while providing @b TMsgBase as common interface class as well as
///     various implementation options. @n
///     See @ref CfgLogfilterPollFields and for definition of the fields this message contains.
