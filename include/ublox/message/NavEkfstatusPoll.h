...
/// @file
/// @brief Contains definition of NAV-EKFSTATUS (@b poll) message and its fields.
...
/// @brief Accumulates details of all the NAV-EKFSTATUS (@b poll) message fields.
/// @see NavEkfstatusPoll
struct NavEkfstatusPollFields
{
    /// @brief All the fields bundled in std::tuple.
    using All = std::tuple<>;
};

/// @brief Definition of NAV-EKFSTATUS (@b poll) message
/// @details Inherits from @b comms::MessageBase
///     while providing @b TMsgBase as common interface class as well as
///     various implementation options. @n
///     See @ref NavEkfstatusPollFields and for definition of the fields this message contains.
